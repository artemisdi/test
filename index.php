...
<div class="main-window">
    <div class="main-window__change" id='mainWindowChange'>
        <div id="formOne"><p>Доброе время суток, нажмите кнопку,когда будете готовы играть</p>
            <div>
                <button id="buttonOne" class='btn btn-dark'>Нажмите</button>
            </div>
        </div>
        <div id="formTwo" class='hidden'><p>нажмите кнопку,когда будете готовы играть</p>
            <p>У вас великолепная память :)</p>
            <div>
        ...
        <div id="formThree" class='hidden'><p>Загадайте двухзначное число</p>
            <div>
                <input type="text" id="dataOne" class="form-control" maxlength="2" placeholder="~10-99~">
                <button id="buttonThree" class='btn btn-dark'>Нажмите</button>
            </div>
        </div>
        <div id="formFour" class='hidden'>
            <table class="table table-bordered">
                <thead class="thead-dark table table-bordered">
                <tr>
                    <td>Экстрасенс JONI</td>
                    <td>Экстрасенс ГРИГОРИЙ</td>
                </tr>
                </thead>
                <tr>
                    <td>Звезды говорят, это число <span id='numberExtraOne'></span></td>
                    <td>Духи подсказывают оно равно <span id='numberExtraTwo'></span></td>
                </tr>
            </table>
            <p>Подтвердите загаданное число</p>
            <div>
                <input type="text" id="dataTwo" class="form-control" maxlength="2" placeholder="~10-99~">
                <button id="buttonFour" class='btn btn-dark'>Нажмите</button>
            </div>
        </div>
    </div>
